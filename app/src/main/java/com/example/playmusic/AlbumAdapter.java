...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.MyHolder> {
    ...
    public AlbumAdapter(Context nContext, ArrayList<MusicFiles> albumFiles) {
        this.nContext = nContext;
        this.albumFiles = albumFiles;
    }

    public AlbumAdapter(Context context, ArrayList<MusicFiles> musicFiles, Object onDeleteOptionClick)
    {
    }
